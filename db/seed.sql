...
insert into rooms (room_number, room_type, occupancy_status, housekeeping_status, maintenance_status, current_guest_name) values
  ...
  ('206', 'DLX', 'vacant', 'clean', 'in_service', null),
  ('207', 'STD', 'vacant', 'clean', 'in_service', null),
  ('208', 'DLX', 'vacant', 'clean', 'in_service', null),
  ('209', 'STD', 'vacant', 'clean', 'in_service', null),
  ('210', 'STE', 'vacant', 'clean', 'in_service', null),
  ...
  ('306', 'DLX', 'vacant', 'clean', 'in_service', null),
  ('307', 'STD', 'vacant', 'clean', 'in_service', null),
  ('308', 'DLX', 'vacant', 'clean', 'in_service', null),
  ('309', 'STD', 'vacant', 'clean', 'in_service', null),
  ('310', 'STE', 'vacant', 'clean', 'in_service', null),
